...
class HelloworldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create helloworld" do
    assert_difference('Helloworld.count') do
      post helloworlds_url, params: { helloworld: { content: @helloworld.content, name: @helloworld.name } }
    end
  ...
  test "should update helloworld" do
    patch helloworld_url(@helloworld), params: { helloworld: { content: @helloworld.content, name: @helloworld.name } }
